...
echo "============================================"
echo "Resuming TRAIN splits (SearchQA + MMLU)"
echo "============================================"

# --- SearchQA train (151,295 samples, resuming from 26,144) ---
echo ""
echo "=== SearchQA train (151,295, resuming from ~26K) ==="
...
# --- MMLU aux_train (99,842 samples) ---
echo ""
echo "=== MMLU aux_train (99,842) ==="
...
echo ""
echo "============================================"
echo "ALL REMAINING TRAIN SPLITS COMPLETE"
echo "============================================"
