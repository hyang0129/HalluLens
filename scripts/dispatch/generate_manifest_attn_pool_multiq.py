"""
generate_manifest_attn_pool_multiq.py — populate pending/ for the Issue #121
multi-query attn_pool sweep (k=2 + k=4, Llama + Qwen3, 6 datasets, seed 0).

Usage:
    python scripts/dispatch/generate_manifest_attn_pool_multiq.py \
        --dispatch-root shared/issue_121_dispatch \
        [--experiment-glob 'configs/experiments/attn_pool_multiq_*.json'] \
        [--seeds 0] \
        [--skip-existing]
"""
...
_DEFAULT_GLOB = "configs/experiments/attn_pool_multiq_*.json"
