"""
generate_manifest_attn_pool_chan.py — populate pending/ for the Issue #120-v2
attn_pool + channel_dropout sweep (Llama + Qwen3, 6 datasets, seed 0).

Usage:
    python scripts/dispatch/generate_manifest_attn_pool_chan.py \
        --dispatch-root shared/issue_120_v2_dispatch \
        [--experiment-glob 'configs/experiments/attn_pool_chan_*.json'] \
        [--seeds 0] \
        [--skip-existing]
"""
...
_DEFAULT_GLOB = "configs/experiments/attn_pool_chan_*.json"
