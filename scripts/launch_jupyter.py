...
so the limits hold regardless of which agent runs it:
    ...
    MAX_ACTIVE_JUPYTER (8)  RUNNING jupyter_* allocations
    MAX_TOTAL_JOBS     (8)  all of the user's jobs, any state (incl. PENDING)
...
MAX_ACTIVE_JUPYTER = 8   # RUNNING jupyter_* jobs
MAX_TOTAL_JOBS = 8       # all jobs in any state, including PENDING/queued
