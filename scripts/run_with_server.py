...
def run_experiment(
    ...
    *,
    ...
    try:
        ...
        if step == "all":
            no_generate_tasks = {"triviaqa", "naturalquestions", "truthfulqa", "hotpotqa", "popqa"}
...
def main():
    ...
    parser.add_argument("--task", required=True, choices=["precisewikiqa", "longwiki", "mixedentities", "triviaqa", "naturalquestions", "truthfulqa", "hotpotqa", "popqa"],
